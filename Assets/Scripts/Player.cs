...
public class Player : MonoBehaviour
{
    ...
    public GameObject inviincibleObj;
    public Image invincibleFill;
    public GameObject fireEffect, splashEffect, winEffect;
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    collision.transform.parent.gameObject.GetComponent<StackController>().ShatterAllParts();
                }
